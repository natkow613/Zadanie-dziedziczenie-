...
class RozowyKwadrat(Kwadrat): #nowa klasa
    def sketchRozowy(self, x, y):
        fill(252, 3, 177)
...
def setup():
    ...
    malyRozowyKwadrat = RozowyKwadrat(50.0)
    malyRozowyKwadrat.sketchRozowy(200, 300)
    rozowyKwadrat = Kwadrat(100.0)
    rozowyKwadrat.sketch(100,100)
    ROZOWYKwadrat = Kwadrat(200.0)
    ROZOWYKwadrat.sketch(200,200)
